...
/**
 * View class for a list of Klisting.
 */
class KlistingViewListings extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        KlistingHelper::addSubmenu('listings');
    ...
    protected function addToolbar() {
        require_once JPATH_COMPONENT . '/helpers/klisting.php';

        $state = $this->get('State');
        $canDo = KlistingHelper::getActions($state->get('filter.category_id'));

        JToolBarHelper::title(JText::_('COM_KLISTING_TITLE_LISTINGS'), 'listings.png');
        ...
        if ($canDo->get('core.admin')) {
            JToolBarHelper::preferences('com_klisting');
        }

        //Set sidebar action - New in 3.0
        JHtmlSidebar::setAction('index.php?option=com_klisting&view=listings');
